...
CLUSTER_NAME="k8s.csye6225-fall2018-jainkr.me"
CLOUD_PROVIDER=aws
...
KOPS_STATE_STORE="s3://k8s.csye6225-fall2018-jainkr.me"        #KOPS_STATE_STORE might already be set as an environment variable, in which case it doesn't have to be changed.
